...
export const SEND_PHONE_SMS_PASSWORD = 'SEND_PHONE_SMS_PASSWORD';
export const SEND_PHONE_SMS_PASSWORD_SUCCESS =
    'SEND_PHONE_SMS_PASSWORD_SUCCESS';
export const SEND_PHONE_SMS_PASSWORD_FAILURE =
...
export const UPDATE_MS_TIME_WAIT = 'UPDATE_MS_TIME_WAIT';
