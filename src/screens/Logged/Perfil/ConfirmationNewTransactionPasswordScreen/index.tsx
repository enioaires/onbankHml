...
const ConfirmationNewTransactionPasswordScreen: React.FC<PerfilStackNavigationProps<
    'NewTransactionPasswordConfirmation'
>> = ({
    navigation
}: PerfilStackNavigationProps<'NewTransactionPasswordConfirmation'>) => {
    ...
    const onPress = () => {
        navigation.push('Perfil', {
            ...
            params: {
                action: () =>
                    dispatch(
                        sendSMSPasswordAction(false, navigation, phoneNumber, true)
                    ),
                loadingPassword: loading,
                fromTransactionPassword: true
            }
        });
    };
                ...
                <SafeAreaView style={styles.safeArea}>
                    <View style={styles.top}>
                        <View>
                            ...
                            {validation.length > 0 && value.length === 4 && (
                                <Text
                                    allowFontScaling={false}
...
export default ConfirmationNewTransactionPasswordScreen;
